...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    sections: Schema.Attribute.DynamicZone<
      ['sections.bloc-element-image', 'sections.bloc-texte-image']
    >;
    seo: Schema.Attribute.Component<'utils.seo', false> &
      Schema.Attribute.Required;
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    liensLegaux: Schema.Attribute.Component<'elements.lien', true>;
    liensReseauxSociaux: Schema.Attribute.Component<
      'elements.lien-reseau',
      true
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
    ...
    menus: Schema.Attribute.Component<'elements.lien', true>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    metadatabase: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    seo: Schema.Attribute.Component<'utils.seo', false>;
  ...
  attributes: {
    ...
    sections: Schema.Attribute.DynamicZone<
      [
        ...
        'sections.faq',
        'sections.marquee',
        'sections.bloc-texte-image',
        'sections.bloc-element-image',
        'sections.formulaire-de-contant',
        'sections.liste-blog',
      ]
    >;
    seo: Schema.Attribute.Component<'utils.seo', false> &
...
export interface ApiTemoignageTemoignage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date_de_publication: Schema.Attribute.Date & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    publishedAt: Schema.Attribute.DateTime;
    temoignage: Schema.Attribute.RichText &
      Schema.Attribute.Required &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
